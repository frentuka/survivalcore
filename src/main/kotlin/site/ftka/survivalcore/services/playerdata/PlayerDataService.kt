...
import site.ftka.survivalcore.services.playerdata.subservices.PlayerDataInputSubservice
import site.ftka.survivalcore.services.playerdata.subservices.PlayerDataOutputSubservice
...
class PlayerDataService(val plugin: MClass) {
    ...
    init {
        ...
        plugin.onProxyInitRunnables.add{
            plugin.server.pluginManager.registerEvents(PlayerDataListener(plugin), plugin)
        }
    }
