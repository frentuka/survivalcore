package site.ftka.proxycore.services.permissions

import com.google.gson.Gson
import site.ftka.proxycore.MClass
import site.ftka.proxycore.services.permissions.objects.PermissionGroup
...
class PermissionsService(val plugin: MClass) {
    ...
    private val groupsFolderLocation: String = "${plugin.dataDirectory.toAbsolutePath()}\\groups"
